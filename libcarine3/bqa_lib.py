...
def insert_BQA(dct,bd):
	...
	if (echeance == 'J_moins_1'):
		...
		req = "INSERT INTO " + bd.table + " (zone_id,date,echeance,indice_o3,indice_no2,indice_pm10,indice_total,indice_dispositif,polluant_id) VALUES(" + str(zone_id) + ",DATE_ADD(CURDATE(), INTERVAL -1 DAY),'current',"+str(o3) + ","+ str(no2) + "," + str(pm10) + ",0,"+ str(multi) + "," + str(poll_id)+");"


	if (echeance == 'J'):

		req = "INSERT INTO " + bd.table + " (zone_id,date,echeance,indice_o3,indice_no2,indice_pm10,indice_total,indice_dispositif,polluant_id) VALUES(" + str(zone_id) + ",CURDATE(),'current',"+str(o3) + ","+ str(no2) + "," + str(pm10) + ",0,"+ str(multi) + "," + str(poll_id)+");"

	if (echeance == 'J_plus_1'):

		req = "INSERT INTO " + bd.table + " (zone_id,date,echeance,indice_o3,indice_no2,indice_pm10,indice_total,indice_dispositif,polluant_id) VALUES(" + str(zone_id) + ",DATE_ADD(CURDATE(), INTERVAL 1 DAY),'current',"+str(o3) + ","+ str(no2) + "," + str(pm10) + ",0,"+ str(multi) + "," + str(poll_id)+");"

	if (echeance == 'J_plus_2'):

		req = "INSERT INTO " + bd.table + " (zone_id,date,echeance,indice_o3,indice_no2,indice_pm10,indice_total,indice_dispositif,polluant_id) VALUES(" + str(zone_id) + ",DATE_ADD(CURDATE(), INTERVAL 2 DAY),'current',"+str(o3) + ","+ str(no2) + "," + str(pm10) + ",0,"+ str(multi) + "," + str(poll_id)+");"
